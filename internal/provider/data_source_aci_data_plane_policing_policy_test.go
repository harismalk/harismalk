		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.aci_data_plane_policing_policy.test", "admin_st", "disabled"),
					resource.TestCheckResourceAttr("data.aci_data_plane_policing_policy.test", "annotation", "orchestrator:terraform"),
					resource.TestCheckResourceAttr("data.aci_data_plane_policing_policy.test", "be", "unspecified"),
					resource.TestCheckResourceAttr("data.aci_data_plane_policing_policy.test", "be_unit", "unspecified"),
					...
					resource.TestCheckResourceAttr("data.aci_data_plane_policing_policy.test", "pir", "0"),
					resource.TestCheckResourceAttr("data.aci_data_plane_policing_policy.test", "pir_unit", "unspecified"),
