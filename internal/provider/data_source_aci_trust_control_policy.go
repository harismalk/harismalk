	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"has_dhcpv4_server": schema.StringAttribute{
				Computed:            true,
				MarkdownDescription: `Contains DHCPv4 servers.`,
			},
			"has_dhcpv6_server": schema.StringAttribute{
				Computed:            true,
				MarkdownDescription: `Contains DHCPv6 servers.`,
			},
			"has_ipv6_router": schema.StringAttribute{
				Computed:            true,
				MarkdownDescription: `Contains IPv6 routers.`,
			},
			...
			"trust_arp": schema.StringAttribute{
				Computed:            true,
				MarkdownDescription: `Trust ARP.`,
			},
			"trust_nd": schema.StringAttribute{
				Computed:            true,
				MarkdownDescription: `Trust ND.`,
			},
			"trust_ra": schema.StringAttribute{
				Computed:            true,
				MarkdownDescription: `Trust router advertisement.`,
			},
