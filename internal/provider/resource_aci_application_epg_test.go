		...
		Steps: []resource.TestStep{
			// Create with minimum config and verify default APIC values
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_application_epg.allow_test", "exception_tag", ""),
					resource.TestCheckResourceAttr("aci_application_epg.allow_test_2", "exception_tag", ""),
					resource.TestCheckResourceAttr("aci_application_epg.allow_test", "flood_on_encap", "disabled"),
					resource.TestCheckResourceAttr("aci_application_epg.allow_test_2", "flood_on_encap", "disabled"),
		...
		Steps: []resource.TestStep{
			// Create with minimum config and verify default APIC values
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_application_epg.test", "exception_tag", ""),
					resource.TestCheckResourceAttr("aci_application_epg.test", "flood_on_encap", "disabled"),
			...
			// Update with all config and verify default APIC values
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_application_epg.test", "exception_tag", "exception_tag_1"),
					resource.TestCheckResourceAttr("aci_application_epg.test", "flood_on_encap", "disabled"),
