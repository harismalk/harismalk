		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.aci_application_epg.test", "exception_tag", ""),
					resource.TestCheckResourceAttr("data.aci_application_epg.test", "flood_on_encap", "disabled"),
